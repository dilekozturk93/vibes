...
- `vibes-testgeneration/src/main/java/be/vibes/testgeneration/experiment/ExperimentRunner.java`
  ...
  values to `automode-reports/metrics/phase0-prelim-metrics.csv` (or
  the path supplied via the `OUTPUT_CSV` env var).
- `automode-reports/metrics/phase0-prelim-metrics.csv` — output of the
...
| `OUTPUT_CSV` | `automode-reports/metrics/phase0-prelim-metrics.csv` | Output path |
