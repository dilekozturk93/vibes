# Per-Product Report — Soda Vending Machine

Generated by `PerProductReportGenerator`. For each valid SVM configuration enumerated by Sat4JSolverFacade, this report shows:
...
- the test case generated for **all-transitions coverage** (a closed Euler cycle),
...
**Selected features:** selected = {b, c, f, svm, t}
...
**Selected features:** selected = {b, s, svm, t}
...
**Selected features:** selected = {b, s, svm}
...
**Selected features:** selected = {b, svm, t}
...
**Selected features:** selected = {b, f, s, svm, t}
...
**Selected features:** selected = {b, c, f, s, svm}
...
**Selected features:** selected = {b, c, s, svm}
...
**Selected features:** selected = {b, f, svm, t}
...
**Selected features:** selected = {b, c, f, s, svm, t}
...
**Selected features:** selected = {b, c, s, svm, t}
...
**Selected features:** selected = {b, c, svm, t}
...
**Selected features:** selected = {b, f, s, svm}
