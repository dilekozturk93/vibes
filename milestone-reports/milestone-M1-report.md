...
>
> 1. **Cardinalities below predate [M0-rev](milestone-M0-rev-report.html).**
...
- `milestone-reports/figures/SodaVendingMachine.{dot,png}`,
 `milestone-reports/figures/eMail.{dot,png}`,
 `milestone-reports/figures/Elevator.{dot,png}`: Dot + Graphviz PNG
 for each MVP SPL.
...
- **PNGs are committed under `milestone-reports/figures/`** rather than
...
**M2 :** implement `StronglyConnectedComponents` (Tarjan's
